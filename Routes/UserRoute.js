...
import transporter from "../mailConfig.js"; // Assuming you have a mailConfig.js for sending emails
...
router.post("/login", async (req, res) => {
    ...
    try {
      ...
      // Ensure otpStore is defined (Assuming it's a Map)
      if (!global.otpStore) {
        global.otpStore = new Map();
      }
  
      // Save OTP to the in-memory store with an expiration time (10 minutes)
      ...
      return res.status(500).json({ message: "Error processing login", error });
    }
  });
